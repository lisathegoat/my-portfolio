...
export const caseStudies = {
  ...
  thesis: {
    ...
    design: {
      ...
      features: [
        { title: 'Lesehelfer', body: 'Durch Modifikationen in Schriftgröße, Schriftart, Hintergrund-Schrift-Kontrast, Silben, Wortbausteine etc. kann das Lesen für Leseanfänger und solche, die anhaltende Probleme im Lesen haben, erleichtert werden. Zusätzlich sollen Features erarbeitet werden, die beim Erlesen und dem Sinnentnehmen von schwierigen Wörtern helfen.', video: '04_1Lesehelfer.mp4' },
        { title: 'Digitaler Karteikasten', body: 'Durch den digitalen Karteikasten sollen die Schüler*innen eine bewährte Lernmethode an die Hand bekommen, um Wörter, die im Erlesen oder im korrekten Schreiben Schwierigkeiten bereiten, unmittelbar zu speichern und infolge zu trainieren.', video: '05_Karteikasten.mp4' },
        { title: 'Feedbackgestützter Rechtschreibchecker', body: 'Der feedbackgestützte Rechtschreibchecker soll den Lernenden die Möglichkeit geben, frei verfasste Texte auf Rechtschreibfehler zu prüfen und mithilfe der FRESCH-Methoden diese selbstständig zu verbessern.', video: '07_Rechtschreibprüfer.mp4' },
        { title: 'Feedback und Lernerfolge', body: 'Durch unmittelbares Feedback nach einer abgeschlossenen Lese-, Trainings- oder Rechtschreibeinheit sollen die Schüler*innen bestärkt und motiviert werden. Über die Lernerfolge können außerdem Lernfortschritte sowie eigene „Rekorde" eingesehen werden. Zum einen soll so die Motivation gegenüber dem Lerngegenstand gesteigert werden und zum anderen sollen die Kinder so Einsichten über ihren eigenen Lernstand erhalten.', video: '08_Lernerfolge.mp4' },
      ],
    },
    ...
    learning: {
      ...
      body: 'Mein größtes Learning war keine Gestaltungsentscheidung, sondern eine Haltungsfrage.\n\nAus der Recherche ging hervor, dass ein explizites Hilfsmittel für Kinder mit LRS im Klassenzimmer Unterschiede sichtbar macht, die Kinder lieber verbergen würden. Diese Erkenntnis hat die gesamte Ausrichtung verändert: nicht ein Tool für eine bestimmte Gruppe, sondern ein System, das eine heterogene Schülerschaft mitdenkt und LRS nicht als Label trägt, sondern als Designperspektive nutzt.',
    },
  },
  ...
  scrollytelling: {
    ...
    meta: {
      role: 'UX/UI Designer',
      status: 'Abgeschlossen',
      imageFolder: '/images/scrollytelling/',
      coverVideo: 'Daten_der_Intersektionalitaet.mp4',
    },
    external: true,
  },
